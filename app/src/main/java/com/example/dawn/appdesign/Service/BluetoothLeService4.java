...
public class BluetoothLeService4 extends Service {
    private final static String TAG = BluetoothLeService4.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeService4 getService() {
            return BluetoothLeService4.this;
        }
    }
